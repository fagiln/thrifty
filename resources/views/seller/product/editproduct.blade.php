    ...
    <form action="{{ route('seller.product.list.update', $product->id) }}" method="POST" class="form"
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex mt-2">
                    ...
                    <div class="card " style="width:18rem; ">
                        <img src="#" id="previewImage" class="card-img-top "
        ...
        <div class="row ">
            <div class="col-md-6">
                ...
                <textarea type="text" class=" form-control" name="description" placeholder="Masukkan Deskripsi">{{ old('description', $product->description) }}</textarea>
                @error('description')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
